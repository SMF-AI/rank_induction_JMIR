...
from camelyon.data_models import Patch, Patches, BinaryLabels, Polygons
from camelyon.patch_filter import AnnotationFilter
...
class Batch:
    ...
    Example:
        >>> from camelyon.datasets import Batch
